...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/api/v1/sessions","method":"post","propertyName":"data.token"},"logout":false,"user":{"url":"/api/v1/users/fetch","method":"get","propertyName":"data"}},"_name":"local"}))
